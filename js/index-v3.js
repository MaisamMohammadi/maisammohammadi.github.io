...
let button4 = document.querySelector('#easy').addEventListener('click', () => {createcards(4)} );

let button16 = document.querySelector('#normal').addEventListener('click', () => {createcards(16)} );

let button36 = document.querySelector('#hard').addEventListener('click', () => {createcards(36)} );
